...
fun main() {
    ...
    box.donuts.add(0, Donut("TONGAN VANILLA BEAN CUSTARD", 1000, listOf("Wheat", "Milk")))
    box.donuts.add(1, Donut("SRI LANKAN CINNAMON SUGAR", 800, listOf("Wheat")))
...
fun Raise<DonutIssue.TooManyCalories>.caloriesChecker(maxCalories: Int, donut: Donut): Donut {
    ensure(donut.calories < maxCalories) {DonutIssue.TooManyCalories(maxCalories,donut.calories)}
    return donut
}
